...
function initialize_network_views_after_node_under_investigation_comp(callback, node_validation_network_structure, node_under_investigation) {
    ...
    setTimeout(() => {
        ...
        callback(node_under_investigation)
